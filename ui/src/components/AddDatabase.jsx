...
const AddDatabase = ({dataset, onClose=null, navigate=null, valueFor, setSelectedDatabase=null, refetch=null}) => {
    ...
    <div className="ps-7 pt-7">
      ...
      <form onSubmit={handleAddDatabase}>
        ...
        {currentStep === 2 && (
          <>
            ...
            {selectedOption === "DynamoDB" && (
              <div className="flex flex-col gap-4">
                <div className="flex flex-col">
                  <label className="text-[12px] font-bold mb-[2px]">RCU</label>
                  <input
                    className="search-input border-2 border-gray-300 focus:border-gray-400 outline-pink-600 max-w-[250px] px-2 py-2 rounded"
                    placeholder="name"
                    type="number"
                ...
                <div className="flex flex-col">
                  <label className="text-[12px] font-bold mb-[2px]">WCU</label>
                  <input
                    className="search-input border-2 border-gray-300 focus:border-gray-400 outline-pink-600 max-w-[250px] px-2 py-2 rounded"
                    placeholder="name"
                    type="number"
        ...
        <div className="flex justify-center gap-3 mt-8">
          <div
            className={`bg-[#E5227A] w-[10px] h-[10px] rounded-full ${
